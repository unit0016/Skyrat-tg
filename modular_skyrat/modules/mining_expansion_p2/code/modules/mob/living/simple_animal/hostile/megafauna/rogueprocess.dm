/mob/living/simple_animal/hostile/megafauna/rogueprocess
	...
	icon = 'modular_skyrat/modules/mining_expansion_p2/icons/mob/lavaland/rogue.dmi'
	icon_state = "rogue"
	icon_living = "rogue"
	...
	ranged = 1
	del_on_death = 0
	crusher_loot = list(/obj/item/crusher_trophy/brokentech, /obj/item/pickaxe/drill/diamonddrill/rogue)
	loot = list(/obj/item/pickaxe/drill/diamonddrill/rogue)
	...
	deathsound = 'sound/mecha/critdestr.ogg'
	anger_modifier = 0
	footstep_type = FOOTSTEP_MOB_HEAVY
	mob_biotypes = MOB_ROBOTIC
	//songs = list("2930" = sound(file = 'modular_skyrat/modules/mining_expansion_p2/sound/ambience/mbrsystemshock.ogg', repeat = 0, wait = 0, volume = 70, channel = CHANNEL_JUKEBOX)) //System shock theme remix by Master Boot Record
	var/special = FALSE
	wander = FALSE
...
/mob/living/simple_animal/hostile/megafauna/rogueprocess/proc/knockdown(range = 2)
	...
	playsound(src,'modular_skyrat/modules/mining_expansion_p2/sound/misc/crunch.ogg', 200, 1)
...
/obj/item/pickaxe/drill/diamonddrill/rogue
	...
	//force_wielded = 20
	//force_unwielded = 5
	icon = 'modular_skyrat/modules/mining_expansion_p2/icons/obj/mining.dmi'
	icon_state = "roguedrill"
	inhand_icon_state = "roguedrill"
	lefthand_file = 'modular_skyrat/modules/mining_expansion_p2/icons/mob/inhands/equipment/mining_lefthand.dmi'
	righthand_file = 'modular_skyrat/modules/mining_expansion_p2/icons/mob/inhands/equipment/mining_righthand.dmi'
	...
	attack_verb_simple = list("drilled")
	var/wielded = FALSE
	var/cooldowntime = 50
	var/cooldown = 0
	var/range = 7

/obj/item/pickaxe/drill/diamonddrill/rogue/Initialize()
	. = ..()
	RegisterSignal(src, COMSIG_TWOHANDED_WIELD, .proc/on_wield)
	RegisterSignal(src, COMSIG_TWOHANDED_UNWIELD, .proc/on_unwield)

/obj/item/pickaxe/drill/diamonddrill/rogue/proc/on_wield(obj/item/source, mob/user)
	SIGNAL_HANDLER
	wielded = TRUE

/obj/item/pickaxe/drill/diamonddrill/rogue/proc/on_unwield(obj/item/source, mob/user)
	SIGNAL_HANDLER
	wielded = FALSE

/obj/item/pickaxe/drill/diamonddrill/rogue/ComponentInitialize()
	. = ..()
	AddComponent(/datum/component/two_handed, force_unwielded=5, force_wielded=20)

/obj/item/pickaxe/drill/diamonddrill/rogue/afterattack(atom/target, mob/living/user, proximity_flag, clickparams)
	. = ..()
